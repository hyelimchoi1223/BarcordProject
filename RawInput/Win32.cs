...
namespace RawInput_dll
{
    static public class Win32
    {
        ...
        public static uint GetDeviceType(string device)
        {
            uint deviceType;
            switch (device)
            {
                case "MOUSE": deviceType = DeviceType.RimTypemouse; break;
                case "KEYBOARD": deviceType = DeviceType.RimTypekeyboard; break;
                case "HID": deviceType = DeviceType.RimTypeHid; break;
                default: deviceType = DeviceType.RimTypeunknown; break;
            }
